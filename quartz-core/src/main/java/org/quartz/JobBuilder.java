...
public class JobBuilder {
    ...
    private JobKey key;//封装job的name和group两个属性
    private String description;//描述是信息
    private Class<? extends Job> jobClass;//job接口的实现类
    private boolean durability;
    private boolean shouldRecover;

    private JobDataMap jobDataMap = new JobDataMap();//job运行可能需要的参数，通过这个map来传递
    ...
    public JobDetail build() {
        ...
        JobDetailImpl job = new JobDetailImpl();//JobDetail接口的唯一实现
